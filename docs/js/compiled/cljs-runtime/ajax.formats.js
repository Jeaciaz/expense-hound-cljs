...
var G__12341 = request;
var G__12342 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__12341,G__12342) : ajax.formats.get_format.call(null,G__12341,G__12342));
} else {
...
return cljs.core.some((function (p1__12351_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__12351_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__12355){
var map__12356 = p__12355;
var map__12356__$1 = cljs.core.__destructure_map(map__12356);
var request = map__12356__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12356__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__12359 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__12359.cljs$core$IFn$_invoke$arity$1 ? fexpr__12359.cljs$core$IFn$_invoke$arity$1(response) : fexpr__12359.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__12362){
var map__12363 = p__12362;
var map__12363__$1 = cljs.core.__destructure_map(map__12363);
var request = map__12363__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12363__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__12360_SHARP_){
return ajax.formats.get_accept_entries(request,p1__12360_SHARP_);
