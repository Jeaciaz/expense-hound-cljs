...
var G__12939 = devtools.prefs.pref(v);
v = G__12939;
continue;
} else {
return v;
...
}catch (e12889){var _e__11435__auto__ = e12889;
return false;
}})();
...
}catch (e12893){var _e__11435__auto__ = e12893;
return false;
}})();
...
}catch (e12898){var _e__11435__auto__ = e12898;
return false;
}}
}
});
...
var vec__12913 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12913,(0),null);
...
return cljs.core.some((function (p1__12922_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__12922_SHARP_);
}),template);
});
