...
var G__12880 = devtools.prefs.pref(v);
v = G__12880;
continue;
} else {
return v;
...
}catch (e12836){var _e__11448__auto__ = e12836;
return false;
}})();
...
}catch (e12842){var _e__11448__auto__ = e12842;
return false;
}})();
...
}catch (e12845){var _e__11448__auto__ = e12845;
return false;
}}
}
});
...
var vec__12862 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12862,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12862,(1),null);
...
return cljs.core.some((function (p1__12866_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__12866_SHARP_);
}),template);
});
