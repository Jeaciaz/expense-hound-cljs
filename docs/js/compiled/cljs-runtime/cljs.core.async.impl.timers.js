...
var i_17843 = (0);
while(true){
if((i_17843 < arr.length)){
(arr[i_17843] = null);

var G__17844 = (i_17843 + (1));
i_17843 = G__17844;
continue;
} else {
}
...
var i_17868 = (self__.level + (1));
while(true){
if((i_17868 <= (new_level + (1)))){
(update[i_17868] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_17870 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_17870[i]));
} else {
x__$2.forward.push((((i < links_17870.length))?(links_17870[i]):null));
}

if((i < links_17870.length)){
(links_17870[i] = x__$2);
} else {
links_17870.push(x__$2);
}
...
var i_17873 = (0);
while(true){
if((i_17873 <= self__.level)){
var links_17874 = (update[i_17873]).forward;
if((x__$1 === (((i_17873 < links_17874.length))?(links_17874[i_17873]):null))){
(links_17874[i_17873] = (x__$1.forward[i_17873]));

var G__17877 = (i_17873 + (1));
i_17873 = G__17877;
continue;
} else {
var G__17878 = (i_17873 + (1));
i_17873 = G__17878;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__17890 = nx;
var G__17891 = (level__$1 - (1));
x = G__17890;
level__$1 = G__17891;
continue;
} else {
var G__17892 = x;
var G__17893 = (level__$1 - (1));
x = G__17892;
level__$1 = G__17893;
continue;
}
