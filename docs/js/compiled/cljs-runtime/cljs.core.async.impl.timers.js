...
var i_17749 = (0);
while(true){
if((i_17749 < arr.length)){
(arr[i_17749] = null);

var G__17750 = (i_17749 + (1));
i_17749 = G__17750;
continue;
} else {
}
...
var i_17767 = (self__.level + (1));
while(true){
if((i_17767 <= (new_level + (1)))){
(update[i_17767] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_17770 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_17770[i]));
} else {
x__$2.forward.push((((i < links_17770.length))?(links_17770[i]):null));
}

if((i < links_17770.length)){
(links_17770[i] = x__$2);
} else {
links_17770.push(x__$2);
}
...
var i_17777 = (0);
while(true){
if((i_17777 <= self__.level)){
var links_17778 = (update[i_17777]).forward;
if((x__$1 === (((i_17777 < links_17778.length))?(links_17778[i_17777]):null))){
(links_17778[i_17777] = (x__$1.forward[i_17777]));

var G__17779 = (i_17777 + (1));
i_17777 = G__17779;
continue;
} else {
var G__17780 = (i_17777 + (1));
i_17777 = G__17780;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__17795 = nx;
var G__17796 = (level__$1 - (1));
x = G__17795;
level__$1 = G__17796;
continue;
} else {
var G__17797 = x;
var G__17798 = (level__$1 - (1));
x = G__17797;
level__$1 = G__17798;
continue;
}
