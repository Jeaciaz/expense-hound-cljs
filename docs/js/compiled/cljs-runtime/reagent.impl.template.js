...
var G__23210 = o;
reagent.impl.template.goog$module$goog$object.set(G__23210,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__23414__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__23414 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__23415__i = 0, G__23415__a = new Array(arguments.length -  0);
while (G__23415__i < G__23415__a.length) {G__23415__a[G__23415__i] = arguments[G__23415__i + 0]; ++G__23415__i;}
  args = new cljs.core.IndexedSeq(G__23415__a,0,null);
} 
return G__23414__delegate.call(this,args);};
G__23414.cljs$lang$maxFixedArity = 0;
G__23414.cljs$lang$applyTo = (function (arglist__23416){
var args = cljs.core.seq(arglist__23416);
return G__23414__delegate(args);
});
...
var G__23225 = o;
reagent.impl.template.goog$module$goog$object.set(G__23225,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__23421__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__23421 = function (var_args){
var args = null;
if (arguments.length > 0) {
...
return G__23421__delegate.call(this,args);};
G__23421.cljs$lang$maxFixedArity = 0;
G__23421.cljs$lang$applyTo = (function (arglist__23423){
var args = cljs.core.seq(arglist__23423);
return G__23421__delegate(args);
});
...
var G__23229 = props;
var G__23229__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23229,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__23229);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23229__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__23239 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23239,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__23239;
}
})(),id_class);
...
var G__23254 = (cljs.core.count(argv) - first_child);
switch (G__23254) {
case (0):
...
var vec__23266 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23266,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23266,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23266,(2),null);
...
var temp__5808__auto___23438 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___23438 == null)){
} else {
var key_23446 = temp__5808__auto___23438;
(jsprops.key = key_23446);
}
...
var temp__5808__auto___23452 = reagent.impl.util.react_key_from_vec(v);
...
var temp__5808__auto___23455 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___23455 == null)){
} else {
var key_23456 = temp__5808__auto___23455;
(jsprops.key = key_23456);
}
...
var temp__5808__auto___23471 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___23471 == null)){
} else {
var key_23475 = temp__5808__auto___23471;
(jsprops.key = key_23475);
}
...
var temp__5808__auto___23479 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___23479 == null)){
} else {
var key_23482 = temp__5808__auto___23479;
(jsprops.key = key_23482);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__23321_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__23321_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__23338 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23338,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23338,(1),null);
...
break;
default:
var G__23502 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__23503 = compiler;
v = G__23502;
compiler = G__23503;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template23368 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template23368 = (function (opts,id,fn_to_element,parse_fn,meta23369){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template23368.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_23370,meta23369__$1){
var self__ = this;
var _23370__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template23368(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta23369__$1));
}));

(reagent.impl.template.t_reagent$impl$template23368.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_23370){
var self__ = this;
var _23370__$1 = this;
return self__.meta23369;
}));

(reagent.impl.template.t_reagent$impl$template23368.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template23368.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template23368.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template23368.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template23368.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template23368.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta23369","meta23369",1505134959,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template23368.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template23368.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template23368");

(reagent.impl.template.t_reagent$impl$template23368.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template23368");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template23368.
 */
reagent.impl.template.__GT_t_reagent$impl$template23368 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template23368(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta23369){
return (new reagent.impl.template.t_reagent$impl$template23368(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta23369));
});

}

return (new reagent.impl.template.t_reagent$impl$template23368(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
