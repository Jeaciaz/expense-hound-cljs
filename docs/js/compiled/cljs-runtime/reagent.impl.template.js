...
var G__12347 = o;
reagent.impl.template.goog$module$goog$object.set(G__12347,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__12365__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__12365 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__12366__i = 0, G__12366__a = new Array(arguments.length -  0);
while (G__12366__i < G__12366__a.length) {G__12366__a[G__12366__i] = arguments[G__12366__i + 0]; ++G__12366__i;}
  args = new cljs.core.IndexedSeq(G__12366__a,0,null);
} 
...
var G__12348 = o;
reagent.impl.template.goog$module$goog$object.set(G__12348,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__12369__i < G__12369__a.length) {G__12369__a[G__12369__i] = arguments[G__12369__i + 0]; ++G__12369__i;}
  args = new cljs.core.IndexedSeq(G__12369__a,0,null);
} 
...
var G__12349 = props;
var G__12349__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12349,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__12349);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12349__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__12350 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12350,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__12350;
}
})(),id_class);
...
var G__12351 = (cljs.core.count(argv) - first_child);
switch (G__12351) {
case (0):
...
var vec__12352 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12352,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12352,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12352,(2),null);
...
var temp__5808__auto___12377 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___12377 == null)){
} else {
var key_12378 = temp__5808__auto___12377;
(jsprops.key = key_12378);
}
...
var temp__5808__auto___12380 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___12380 == null)){
} else {
var key_12381 = temp__5808__auto___12380;
(jsprops.key = key_12381);
}
...
var temp__5808__auto___12385 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___12385 == null)){
} else {
var key_12387 = temp__5808__auto___12385;
(jsprops.key = key_12387);
}
...
var temp__5808__auto___12393 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___12393 == null)){
} else {
var key_12394 = temp__5808__auto___12393;
(jsprops.key = key_12394);
}
...
var temp__5808__auto___12396 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___12396 == null)){
} else {
var key_12399 = temp__5808__auto___12396;
(jsprops.key = key_12399);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12355_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__12355_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__12356 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12356,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12356,(1),null);
...
break;
default:
var G__12403 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__12404 = compiler;
v = G__12403;
compiler = G__12404;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template12362 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template12362 = (function (opts,id,fn_to_element,parse_fn,meta12363){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template12362.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_12364,meta12363__$1){
var self__ = this;
var _12364__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template12362(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta12363__$1));
}));

(reagent.impl.template.t_reagent$impl$template12362.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_12364){
var self__ = this;
var _12364__$1 = this;
return self__.meta12363;
}));

(reagent.impl.template.t_reagent$impl$template12362.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template12362.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template12362.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template12362.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template12362.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template12362.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta12363","meta12363",2054398673,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template12362.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template12362.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template12362");

(reagent.impl.template.t_reagent$impl$template12362.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template12362");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template12362.
 */
reagent.impl.template.__GT_t_reagent$impl$template12362 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template12362(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta12363){
return (new reagent.impl.template.t_reagent$impl$template12362(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta12363));
});

}

return (new reagent.impl.template.t_reagent$impl$template12362(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
