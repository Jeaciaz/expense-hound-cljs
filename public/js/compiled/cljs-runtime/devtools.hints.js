...
var temp__5802__auto___12961 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5802__auto___12961)){
var seen_errors_12962 = temp__5802__auto___12961;
if(cljs.core.truth_(seen_errors_12962.has(self))){
} else {
seen_errors_12962.add(self);

var temp__5804__auto___12963 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5804__auto___12963)){
var sense_12964 = temp__5804__auto___12963;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_12964)].join(''));
} else {
}
}
} else {
