...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_15150 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_15150(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_15152 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_15152(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_15154 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_15154(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_15158 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_15158(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_15163 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_15163(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_15166 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_15166(reader);
}
});
...
var G__15239 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__15240 = s.append(c);
c = G__15239;
s = G__15240;
continue;
}
