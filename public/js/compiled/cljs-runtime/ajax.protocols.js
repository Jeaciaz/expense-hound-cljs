...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_12126 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_12126(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_12128 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_12128(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_12131 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_12131(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_12133 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_12133(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_12137 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_12137(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_12144 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_12144(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_12152 = (function (this$,header){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_12152(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_12156 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_12156(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_12163 = (function (this$,request){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_12163(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_12172 = (function (this$,response){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_12172(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k12110,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k12110,else__5346__auto__);
...
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12116,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12116,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__12109){
var self__ = this;
var G__12109__$1 = this;
return (new cljs.core.RecordIter((0),G__12109__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this12111,other12112){
var self__ = this;
var this12111__$1 = this;
return (((!((other12112 == null)))) && ((((this12111__$1.constructor === other12112.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this12111__$1.status,other12112.status)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this12111__$1.body,other12112.body)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this12111__$1.status_text,other12112.status_text)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this12111__$1.headers,other12112.headers)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this12111__$1.was_aborted,other12112.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this12111__$1.__extmap,other12112.__extmap)))))))))))))));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k12110){
var self__ = this;
var this__5350__auto____$1 = this;
var G__12119 = k12110;
var G__12119__$1 = (((G__12119 instanceof cljs.core.Keyword))?G__12119.fqn:null);
switch (G__12119__$1) {
case "status":
case "body":
case "status-text":
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k12110);

}
}));

(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__12109){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__12120 = cljs.core.keyword_identical_QMARK_;
var expr__12121 = k__5352__auto__;
if(cljs.core.truth_((pred__12120.cljs$core$IFn$_invoke$arity$2 ? pred__12120.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__12121) : pred__12120.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__12121)))){
return (new ajax.protocols.Response(G__12109,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__12120.cljs$core$IFn$_invoke$arity$2 ? pred__12120.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__12121) : pred__12120.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__12121)))){
return (new ajax.protocols.Response(self__.status,G__12109,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__12120.cljs$core$IFn$_invoke$arity$2 ? pred__12120.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__12121) : pred__12120.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__12121)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__12109,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__12120.cljs$core$IFn$_invoke$arity$2 ? pred__12120.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__12121) : pred__12120.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__12121)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__12109,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__12120.cljs$core$IFn$_invoke$arity$2 ? pred__12120.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__12121) : pred__12120.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__12121)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__12109,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__12109),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__12109){
var self__ = this;
var this__5342__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__12109,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__12113){
var extmap__5385__auto__ = (function (){var G__12123 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__12113,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__12113)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__12123);
} else {
return G__12123;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__12113),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__12113),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__12113),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__12113),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__12113),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
